        ...
        <div className="space-y-6">
            ...
            <Modal isOpen={!!documentToView} onClose={() => setDocumentToView(null)} title={documentToView ? (documentToView.type === 'invoice' ? 'Invoice' : 'Tanda Terima') : ''} size="3xl">
                ...
                <div className="mt-6 text-right non-printable space-x-2 border-t border-brand-border pt-4">
                    ...
                    <button type="button" onClick={() => (window as any).__venaPrintFull(documentToView ? (documentToView.type === 'invoice' ? `Invoice - ${documentToView.project?.projectName || ''}` : 'Tanda Terima') : 'Dokumen')} className="button-primary inline-flex items-center gap-2"><PrinterIcon className="w-4 h-4"/> Cetak Penuh</button>
                </div>
            </Modal>
